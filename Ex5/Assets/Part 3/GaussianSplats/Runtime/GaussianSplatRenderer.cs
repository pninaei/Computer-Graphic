...
namespace GaussianSplatting.Runtime
{
    ...
    public class GaussianSplatRenderer : MonoBehaviour
    {
        ...
        internal static class Props
        {
            ...
            public static readonly int SplatBoundsMin = Shader.PropertyToID("_BoundsMin");
            public static readonly int SplatBoundsMax = Shader.PropertyToID("_BoundsMax");
        }
        ...
        internal void SetAssetDataOnMaterial(MaterialPropertyBlock mat)
        {
            ...
            // Set bounds (max, min)
            mat.SetVector(Props.SplatBoundsMin, m_Asset.boundsMin);
            mat.SetVector(Props.SplatBoundsMax, m_Asset.boundsMax);
